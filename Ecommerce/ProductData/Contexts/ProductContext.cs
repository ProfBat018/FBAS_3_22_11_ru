...
public partial class ProductContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AttributeId).HasName("PK__Attribut__C189298A0B2F4F35");
        ...
        {
            entity.HasKey(e => e.AttributeValueId).HasName("PK__Attribut__335E2256AAA9F023");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B58180F58");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF646CEE63");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__57ED06A1EAC03A7E");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__OrderSta__C8EE2043C2437DC0");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED059FF9CF");
            ...
            entity.HasMany(d => d.AttributeValues).WithMany(p => p.Products)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<AttributeValue>().WithMany()
                        ...
                        .HasConstraintName("FK__ProductAt__Attri__44FF419A"),
                    l => l.HasOne<Product>().WithMany()
                        .HasForeignKey("ProductId")
                        .HasConstraintName("FK__ProductAt__Produ__440B1D61"),
                    j =>
                    {
                        j.HasKey("ProductId", "AttributeValueId").HasName("PK__ProductA__C73924C864F6E544");
            ...
            entity.HasMany(d => d.Categories).WithMany(p => p.Products)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ProductId", "CategoryId").HasName("PK__ProductC__159C554F7F6C153C");
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFD945C5098D");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.Warehouses)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__Warehouse__Produ__48CFD27E");
        });
