...
public partial class Academy2Context : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        .UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Academy2;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=True;Application Intent=ReadWrite;");
    }
